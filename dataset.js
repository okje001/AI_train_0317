...
d2.set_concontent("mnist 데이터 컨볼루션 다중분류")//서브 타이틀
data_sets.push(d2)d2.set_img(2,{imgtitle:"mnist데이터 수신 및 셔플링",imglog:"손글씨 다운로드 및 셔플링 수행",imgurl:"https://drive.google.com/file/d/19kl3yqqcViudod3vclT5Kbv1Omgxa1em/view?usp=drive_link",sourceurl:"https://github.com/okje001/AI_train_0317/blob/main/Calssifi_mnist_conv_advan/mnist_conv_main.py"})//이미지타이틀
data_sets.push(d2)d2.set_img(2,{imgtitle:"데이터스케일링 및 원핫인코딩",imglog:"문제데이터min-max scaling,정답데이터 one hot encoding",imgurl:"https://drive.google.com/file/d/1IEwz-DCshZOKpR8w46WfNEfUz52xq4t8/view?usp=drive_link",sourceurl:"https://github.com/okje001/AI_train_0317/blob/main/Calssifi_mnist_conv_advan/mnist_conv_main.py"})//이미지타이틀
data_sets.push(d2)d2.set_img(2,{imgtitle:"훈련콜백함수",imglog:"earlystop, callback, ModelCheckpint callbalck 객체 생성",imgurl:"https://drive.google.com/file/d/1mknEywgaB0ZSgCgaufPbcIpfI9Yi3uZi/view?usp=drive_link",sourceurl:"https://github.com/okje001/AI_train_0317/blob/main/Calssifi_mnist_conv_advan/mnist_conv_main.py"})//이미지타이틀
data_sets.push(d2)d2.set_img(2,{imgtitle:"모델컴파일 및 훈련실행",imglog:"조기종료 및 최적화저장 콜백 주입 후 훈련 실행",imgurl:"https://drive.google.com/file/d/1MN_tyH1K5Byc7YjlJ5D2csZmMiGzsgO1/view?usp=drive_link",sourceurl:"https://github.com/okje001/AI_train_0317/blob/main/Calssifi_mnist_conv_advan/mnist_conv_main.py"})//이미지타이틀
data_sets.push(d2)d2.set_img(2,{imgtitle:"조기 종료 및 체크포인트저장",imglog:"최적의 정확률로 조기종료실행 및 최적의 손실값으로 자동저장 수행",imgurl:"https://drive.google.com/file/d/1vT9N3V5d62Sb_Uavz6bSolRF1Jadwe6J/view?usp=drive_link",sourceurl:"https://github.com/okje001/AI_train_0317/blob/main/Calssifi_mnist_conv_advan/mnist_conv_main.py"})//이미지타이틀
data_sets.push(d2)d2.set_img(2,{imgtitle:"훈련결과시각화",imglog:"훈련결과를 시각화하여 최적의 모델을 선택하는 판단 기준",imgurl:"https://drive.google.com/file/d/1Gefo43_e16plTWEpwcy7Y68leDO9_N2v/view?usp=drive_link",sourceurl:"https://github.com/okje001/AI_train_0317/blob/main/Calssifi_mnist_conv_advan/mnist_conv_main.py"})//이미지타이틀
data_sets.push(d2)d2.set_img(2,{imgtitle:"최적모델 선택",imglog:"시각화 결과와 테스트 데이터 측정평가로 정확률과 손실도가 최적화된 모델 선택",imgurl:"https://drive.google.com/file/d/1Du-lO433DHdxt4A_PjPjh2qe1Uqhpb56/view?usp=drive_link",sourceurl:"https://github.com/okje001/AI_train_0317/blob/main/Calssifi_mnist_conv_advan/mnist_conv_main.py"})//이미지타이틀
data_sets.push(d2)d2.set_img(2,{imgtitle:"테스트측정",imglog:"테스트결과 시각화",imgurl:"https://drive.google.com/file/d/1qYShwvoChEm9tjvXsFFTKgKlODJwguMZ/view?usp=drive_link",sourceurl:"https://github.com/okje001/AI_train_0317/blob/main/Calssifi_mnist_conv_advan/mnist_conv_main.py"})//이미지타이틀
data_sets.push(d2)d2.set_img(2,{imgtitle:"사용자 이미지판별",imglog:"그림판으로 작성하여 저장된 이미지를 불러와서 모델의 판별테스트",imgurl:"https://drive.google.com/file/d/1pT86GsAXXk4zhQ0uheampSVqVLlERDdk/view?usp=drive_link",sourceurl:"https://github.com/okje001/AI_train_0317/blob/main/Calssifi_mnist_conv_advan/Test_mnist_conv_advan.py"})//이미지타이틀
data_sets.push(d2)d2.set_img(2,{imgtitle:"실제이미지판별",imglog:"6개의 실제 이미지를 제작하여 모델의 예측능력 판별",imgurl:"https://drive.google.com/file/d/19qXeS8APZgqr9cs0q0FzWQBVV3yhaRVm/view?usp=drive_link",sourceurl:"https://github.com/okje001/AI_train_0317/blob/main/Calssifi_mnist_conv_advan/Test_mnist_conv_advan.py"})//이미지타이틀
data_sets.push(d2)d2.set_img(2,{imgtitle:"콜백함수에 의해 저장된 모델",imglog:"콜백함수에 의해 저장된 모델들의 저장된 스냅샷",imgurl:"https://drive.google.com/file/d/1MdJXdIl6LVI_7gS-5pdFrdKyKnf77NgZ/view?usp=drive_link",sourceurl:"https://github.com/okje001/AI_train_0317/blob/main/Calssifi_mnist_conv_advan/Test_mnist_conv_advan.py"})//이미지타이틀
