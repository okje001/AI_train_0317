...
menu0.url = "?menu=0"
menu0.tips = ["1.1 보스턴 주택가격 예측","1.2 캘리포니아 주택가격 예측","1.3 당뇨"]
menu1 = new Menu("2. 분류모델 구축")
menu1.url = "?menu=1"
menu1.tips = ["fashion_mnist_softmax","2.2 컨볼루션레이어 적용모델(CNN)","2.3 가상화폐 가격분석 회귀(실무)"] //로그인 로그아웃 기능
